...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('customer/dashboard',compact('user','shipments','audited_exporters','audited_shipment','failed_shipments','passed_shipments','shipments_waiting_sampling','shipment_waiting_lab'));
    }
