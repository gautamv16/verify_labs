...
class ExporterController extends Controller
{
     ...
     public function index()
    {
        $users = Exporter::with(['countryName'])->where('status','=',1)->get();
          ...
          return view('customer.exporters.index',compact('users','status','approved_farm'));
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect()->to('/customer/exporters')->with('success','Exporter created successfully!');
        }catch(\Exception $e){
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('customer.exporters.edit',compact('user'));
    }
    ...
    public function update(Request $request,$id)
    {
         try{
            ...
            $exporter->save();
            return redirect()->to('/customer/exporters')->with('success','Exporter Updated successfully!');
        }catch(\Exception $e){
            return redirect()->back()->with('error',$e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        try{
             ...
             $admin->delete(); 
            return redirect()->to('/customer/exporters')->with('success','Exporter Deleted successfully!');
        }catch(\Exception $e){
            return redirect()->back()->with('error',$e->getMessage());
        }
    }
