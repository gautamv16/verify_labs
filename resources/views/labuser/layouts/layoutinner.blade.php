...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="{{route('lab.dashboard')}}">{{Auth::guard('admins')->user()->office_location->name}} Lab</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button><!-- Navbar Search-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>Exporters</a>
                        <a class="nav-link" href="{{route('lab.shipments')}}">
                        <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>Shipments</a>
