        ...
        <div class="table-responsive">
            <table class="table table-striped">
              ...
              @if(count($sampling_shipments) > 0)
                ...
                <tr>
                <th scope="row"><a href="{{ route('admin.shipment.get_step_two',['id'=>$shipment->record_id])}}">{{$shipment->uae_firs_number}}</a></th>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                <th scope="row"><a href="{{ route('admin.shipment.get_step_three',['id'=>$shipment->record_id])}}">{{$shipment->uae_firs_number}}</a></th>
                  <td>{{$shipment->exporter->name}}</td>
                  <td>{{$shipment->importer->name}}</td>
